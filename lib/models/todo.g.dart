...
extension TodoQueryWhereSort on QueryBuilder<Todo, Todo, QWhere> {
  ...
  QueryBuilder<Todo, Todo, QAfterWhere> anyCompletedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension TodoQueryWhere on QueryBuilder<Todo, Todo, QWhereClause> {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> completedAtIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> completedAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'completedAt',
        lower: [null],
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> completedAtEqualTo(
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> completedAtNotEqualTo(
      DateTime? completedAt) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> completedAtGreaterThan(
    DateTime? completedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> completedAtLessThan(
    DateTime? completedAt, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Todo, Todo, QAfterWhereClause> completedAtBetween(
